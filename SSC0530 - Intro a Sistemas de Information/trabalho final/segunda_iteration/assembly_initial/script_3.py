# Agora vou preparar o texto sistematizado unificado em formato markdown
# seguindo a estrutura requerida e integrando as informações validadas

texto_sistematizado = """# Sistema Integrado de Monitoramento e Gestão Energética para UBS
...
# Salvar o texto sistematizado em um arquivo markdown
with open("texto_sistematizado.md", "w", encoding="utf-8") as f:
    f.write(texto_sistematizado)

print("Texto sistematizado criado com sucesso! Agora vou preparar os infográficos.")

# Descrever os conceitos para os infográficos
print("\n=== CONCEITOS PARA INFOGRÁFICOS ===")
print("\nInfográfico 1: Desafio e Solução")
print("- Foco: Visualização do problema (perdas de vacinas + desperdício energético) e solução integrada")
print("- Elementos principais: Estatísticas TCU, diagrama de sistema, ROI")
print("- Estilo: Informativo/técnico")

print("\nInfográfico 2: Fluxo Tecnológico")
print("- Foco: Arquitetura técnica e fluxo de dados do sistema")
print("- Elementos principais: Sensores, nuvem, processamento, interfaces")
print("- Estilo: Diagrama técnico com ícones")

print("\nInfográfico 3: Impacto e Benefícios")
print("- Foco: Resultados esperados e vantagens da implementação")
print("- Elementos principais: Economia energética, redução de perdas, melhorias operacionais")
print("- Estilo: Visual com gráficos e métricas-chave")